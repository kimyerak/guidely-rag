...
class RelevanceService:
    ...
    def check_relevance(self, user_message: str) -> bool:
        ...
        Returns:
            bool: 관련성 여부
        """
        # 관련 키워드들 (호랑이 전시 + 케이팝데몬헌터스 중심)
        relevant_keywords = [
            # 호랑이 전시 관련
            '호랑이', '범범', '까치', '호랑이전시', '호랑이 전시', '범범이', '까치문양', '전통', '문양',
            '국립중앙박물관', '박물관', '전시', '전시회', '전시장', '관람', '티켓', '입장', '작품', '유물',
            # 케이팝데몬헌터스 관련
            '케이팝데몬헌터스', '데몬헌터', '케이팝데몬', '헌터스', '데몬', '헌터', '게임', '캐릭터',
            # 케이팝 관련 (호랑이 캐릭터 인기로 연결)
            '케이팝', 'kpop', 'k-pop', '아이돌', '음악', '가수', '그룹', '앨범', '곡', '뮤직비디오',
            # 미술/예술 관련
        ...
        # 명확히 관련없는 키워드들
        irrelevant_keywords = [
            '날씨', '주식', '부동산', '정치', '경제', '뉴스', '스포츠', '게임', '영화', '드라마',
            '요리', '레시피', '건강', '의료', '병원', '약', '운동', '다이어트', '여행', '호텔',
            '쇼핑', '구매', '결제', '배송', '환불', '고객서비스', '기술지원'
        ]
